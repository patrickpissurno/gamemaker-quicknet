...
else if(len < max_length && !(keyboard_check(vk_backspace) || keyboard_check(vk_delete) || keyboard_check(vk_enter) || keyboard_check(vk_escape) || keyboard_check(vk_left) || keyboard_check(vk_right) || keyboard_check(vk_up) || keyboard_check(vk_down)) && keyboard_check_pressed(vk_anykey))
{
    if(keyboard_string != ""){
